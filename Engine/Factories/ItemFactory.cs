...
namespace Engine.Factories
{
    public static class ItemFactory
    {
        ...
        static ItemFactory()
        {
            ...
            _standardGameItems.Add(new GameItem(64, "Bear Jelly Coins", 1, "pack://application:,,,/Engine;component/Images/Items/Bear"));
            ...
            _standardGameItems.Add(new GameItem(71, "The Jelly of Memories", 10, ""));
            _standardGameItems.Add(new Weapon(72, "Cookie Axe", 10, "", 2, 7));
            _standardGameItems.Add(new Weapon(73, "Cookie Gun", 10, "", 2, 7));
